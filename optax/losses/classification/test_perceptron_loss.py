...
# ==============================================================================
"""Tests for optax.losses.classification.perceptron_loss and multiclass_perceptron_loss."""
...
import numpy as np
from optax.losses.classification import perceptron_loss, multiclass_perceptron_loss
...
class PerceptronTest(parameterized.TestCase):
    def test_binary(self):
        ...
        result = perceptron_loss(score, signed_label)
    ...
    def test_batched_binary(self):
        ...
        result = perceptron_loss(scores, signed_labels)
        np.testing.assert_allclose(result, expected, atol=1e-4)
    ...
    def test_multi_class(self):
        ...
        result = multiclass_perceptron_loss(scores, label)
        np.testing.assert_allclose(result, expected, atol=1e-4)
