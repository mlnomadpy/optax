...
# ==============================================================================
"""Unit tests for scale_by_param_block_rms transformation."""
...
class ScaleByParamBlockRmsTest(chex.TestCase):
  ...
  @chex.all_variants
  def test_scale_by_param_block_rms(self):
    params = self.init_params
    scaler = scale_by_param_block_rms()
