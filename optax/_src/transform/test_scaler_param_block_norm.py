...
# ==============================================================================
"""Unit tests for scale_by_param_block_norm transformation."""
...
class ScaleByParamBlockNormTest(chex.TestCase):
  ...
  @chex.all_variants
  def test_scale_by_param_block_norm(self):
    params = self.init_params
    scaler = scale_by_param_block_norm()
