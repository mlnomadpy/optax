...
# ==============================================================================
"""Unit tests for scale_by_distance_over_gradients transformation."""
...
class ScaleByDistanceOverGradientsTest(chex.TestCase):
  ...
  @chex.all_variants
  def test_scale_by_distance_over_gradients(self):
    params = self.init_params
    scaler = scale_by_distance_over_gradients()
