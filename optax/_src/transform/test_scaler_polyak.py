...
# ==============================================================================
"""Unit tests for scale_by_polyak transformation's scaler behavior."""
...
class ScaleByPolyakScalerTest(chex.TestCase):
  ...
  @chex.all_variants
  def test_scale_by_polyak_scaler(self):
    params = self.init_params
    scaler = scale_by_polyak()
