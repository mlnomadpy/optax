...
# ==============================================================================
"""Unit tests for normalize_by_update_norm transformation."""
...
class NormalizeByUpdateNormTest(chex.TestCase):
  ...
  @chex.all_variants
  def test_normalize_by_update_norm(self):
    params = self.init_params
    scaler = normalize_by_update_norm()
